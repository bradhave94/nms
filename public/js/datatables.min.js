 ...
 *   https://datatables.net/download/#dt/jq-3.6.0/dt-1.12.1/b-2.2.3/b-colvis-2.2.3/b-html5-2.2.3/b-print-2.2.3/sp-2.0.2
 *
 * Included libraries:
 *   jQuery 3 3.6.0, DataTables 1.12.1, Buttons 2.2.3, Column visibility 2.2.3, HTML5 export 2.2.3, Print view 2.2.3, SearchPanes 2.0.2
 */
...
(function (l) {
	...
	function Jb(a) {
		...
		for (b = g.length; k < b; k++) {
			...
			a.oFeatures.bSort &&
				...
				!1 !== m.bSortable && (n.attr('tabindex', a.iTabIndex).attr('aria-controls', a.sTableId), kb(a, m.nTh, k)));
	...
	function Qa(a, b, c) {
		...
		m = {
			...
			error: function (n, p, t) {
				...
				-1 === l.inArray(!0, t) &&
					('parsererror' == p ? ea(a, 0, 'Invalid JSON response', 1) : 4 === n.readyState && ea(a, 0, 'Ajax error', 7));
				V(a, !1);
			},
		};
		a.oAjaxData = b;
	...
	function Za(a, b, c) {
		if (y.moment) {
			...
			b
				? (kc || alert('DataTables warning: Formatted date without Moment.js or Luxon - https://datatables.net/tn/17'),
				  (kc = !0))
				: (d = new Date(a));
		return d;
	}
	...
	var Hc = function (a, b, c, d) {
		...
		Cb = function (a, b) {
			...
			c.length &&
				...
				a._details &&
				(a._details.remove(), (a._detailsShow = q), (a._details = q), l(a.nTr).removeClass('dt-hasChild'), wc(c));
		},
		xc = function (a, b) {
			var c = a.context;
	...
	u.ext = M = {
		buttons: {},
		classes: {},
		build: 'dt/jq-3.6.0/dt-1.12.1/b-2.2.3/b-colvis-2.2.3/b-html5-2.2.3/b-print-2.2.3/sp-2.0.2',
		errMode: 'alert',
		feature: [],
		search: [],
			...
			var c = [],
				...
				h = function (l, m) {
					...
					if (Array.isArray(l) || l instanceof d) for (n = 0, r = l.length; n < r; n++) h(l[n], m);
						...
						'object' === typeof l && l.nodeName && ((q = d.inArray(l, n)), -1 !== q && c.push({ inst: m, node: n[q] }));
				},
				f = 0,
				g = a.length;
			f < g;
...
(function (n) {
	...
	function O(a, c) {
		J === B &&
			(J =
				-1 ===
				M.serializeToString(new u.DOMParser().parseFromString(P['xl/worksheets/sheet1.xml'], 'text/xml')).indexOf(
					'xmlns:r'
				));
							...
							(k[l].match && k[l].match(/^-?\d+(\.\d+)?([eE]\-?\d+)?$/) && !k[l].match(/^0\d+/))
								...
								: ((H = H.replace ? H.replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, '') : H),
								  (A = y(f, 'c', {
										...
										children: {
											row: y(f, 'is', { children: { row: y(f, 't', { text: H, attr: { 'xml:space': 'preserve' } }) } }),
										},
								  }))));
						h.appendChild(A);
					}
...
$jscomp.polyfill(
	...
	function (l) {
		...
		q.prototype.set = function (r, p) {
			...
			u.entry
				? (u.entry.value = p)
				: ((u.entry = { next: this.head_, previous: this.head_.previous, head: this.head_, key: r, value: p }),
				  u.list.push(u.entry),
	...
	var k,
		...
		v = (function () {
			function h(b, a, c, d, e) {
				...
				this.dom = {
					...
					container: k('<div/>')
						...
						.addClass(
							this.classes.layout +
								(10 > parseInt(this.c.layout.split('-')[1], 10) ? this.c.layout : this.c.layout.split('-')[0] + '-9')
						)
						.addClass(
				...
				this.s.searchFunction = function (m, t, w) {
					...
					f.s.colExists &&
						...
						'filter' !== f.s.colOpts.orthogonal.filter &&
							((m = f.s.rowData.filterMap.get(w)), m instanceof k.fn.dataTable.Api && (m = m.toArray())));
			...
			h.prototype.adjustTopRow = function () {
				...
				(252 > k(b[0]).width() || 252 > k(d[0]).width()) && 0 !== k(b[0]).width()
					? (k(b[0]).addClass(this.classes.narrow),
					  k(a[0]).addClass(this.classes.narrowSub).removeClass(this.classes.narrowSearch),
					  k(c[0]).addClass(this.classes.narrowSub).removeClass(this.classes.narrowButton))
					: (k(b[0]).removeClass(this.classes.narrow),
					  k(a[0]).removeClass(this.classes.narrowSub).addClass(this.classes.narrowSearch),
					  k(c[0]).removeClass(this.classes.narrowSub).addClass(this.classes.narrowButton));
			};
			...
			h.prototype.destroy = function () {
				...
				for (var b = k.fn.dataTable.ext.search.indexOf(this.s.searchFunction); -1 !== b; )
					k.fn.dataTable.ext.search.splice(b, 1), (b = k.fn.dataTable.ext.search.indexOf(this.s.searchFunction));
			...
			h.prototype.setListeners = function () {
				...
				this.s.dtPane &&
						...
						this.s.dt.on('stateSaveParams.dtsp', function (a, c, d) {
							if (k.isEmptyObject(d)) b.s.dtPane.state.clear();
								...
								for (c = 0; c < d.searchPanes.panes.length; c++)
									d.searchPanes.panes[c].id === b.s.index && (d.searchPanes.panes.splice(c, 1), c--);
					...
					this.dom.searchBox.off('click.dtsp').on('input.dtsp', function () {
						...
						'string' === typeof a &&
						(0 < a.length || (0 === a.length && 0 < b.s.dtPane.rows({ selected: !0 }).data().toArray().length))
							? b.dom.clear.removeClass(b.classes.disabledButton).removeAttr('disabled')
							: b.dom.clear.addClass(b.classes.disabledButton).attr('disabled', 'true');
						b.s.dt.state.save();
					}),
			...
			h.prototype._serverPopulate = function (b) {
				...
				else if (null === this.s.tableLength || this.s.dt.rows()[0].length > this.s.tableLength)
				...
				if (b.searchPanes.options[a]) {
					...
					for (b = b.searchPanes.options[a]; c < b.length; c++)
						(a = b[c]),
							this.s.rowData.arrayFilter.push({ display: a.label, filter: a.value, sort: a.label, type: a.label }),
			...
			h.prototype._populatePaneArray = function (b, a, c, d) {
				...
				if ('string' === typeof this.s.colOpts.orthogonal)
					(c = c.oApi._fnGetCellData(c, b, this.s.index, this.s.colOpts.orthogonal)),
			...
			h.prototype._updateSelection = function (b) {
				...
				this.s.dt.page.info().serverSide && !this.s.updating
					? this.s.serverSelecting ||
					  ((this.s.serverSelect = this.s.dtPane.rows({ selected: !0 }).data().toArray()), this.s.dt.draw(!1))
				...
				if (Array.isArray(b) || b instanceof q.Api)
					if ((b instanceof q.Api && ((b = b.toArray()), (a = a.toArray())), b.length === a.length))
						for (var g = 0; g < b.length; g++)
							f[b[g]] ? f[b[g]]++ : ((f[b[g]] = 1), e.push({ display: a[g], filter: b[g], sort: c[g], type: d[g] })),
								this.s.rowData.totalOptions++;
					else throw Error('display and filter not the same length');
				else
					'string' === typeof this.s.colOpts.orthogonal
						? (f[b] ? f[b]++ : ((f[b] = 1), e.push({ display: a, filter: b, sort: c, type: d })),
						  this.s.rowData.totalOptions++)
			...
			h.prototype._buildPane = function (b, a, c) {
				...
				if (this.s.colExists) {
					...
					if (
						(!1 === this.s.colOpts.show || (void 0 !== this.s.colOpts.show && !0 !== this.s.colOpts.show)) &&
						-1 === f
					)
						return this.dom.container.addClass(this.classes.hidden), (this.s.displayed = !1);
					if (!0 === this.s.colOpts.show || -1 !== f) this.s.displayed = !0;
					if (this.s.dt.page.info().serverSide || (a && a.searchPanes && a.searchPanes.options))
			...
			h.prototype._populatePane = function () {
				...
				if (!this.s.dt.page.info().serverSide)
					for (var a = 0, c = this.s.dt.rows().indexes().toArray(); a < c.length; a++)
		...
		C = (function (h) {
			...
			b.prototype._serverPopulate = function (a) {
				...
				if (void 0 !== a.tableLength)
					(this.s.tableLength = a.tableLength), (this.s.rowData.totalOptions = this.s.tableLength);
				else if (null === this.s.tableLength || this.s.dt.rows()[0].length > this.s.tableLength)
					(this.s.tableLength = this.s.dt.rows()[0].length), (this.s.rowData.totalOptions = this.s.tableLength);
			...
			b.prototype.updateRows = function () {
				if (!this.s.dt.page.info().serverSide) {
					this.s.rowData.binsShown = {};
					for (var a = 0, c = this.s.dt.rows({ search: 'applied' }).indexes().toArray(); a < c.length; a++)
						this._updateShown(c[a], this.s.dt.settings()[0], this.s.rowData.binsShown);
				}
				a = 0;
		...
		E = (function (h) {
			...
			b.prototype._activePopulatePane = function () {
				...
				if (!this.s.dt.page.info().serverSide)
					for (var c = 0, d = this.s.dt.rows({ search: 'applied' }).indexes().toArray(); c < d.length; c++)
		...
		J = (function (h) {
			function b(a, c, d, e, f) {
				return (
					h.call(this, a, N.extend({ i18n: { count: '{total}', countFiltered: '{shown} ({total})' } }, c), d, e, f) ||
					this
				);
			}
			P(b, h);
			b.prototype._activePopulatePane = function () {
				...
				if (!this.s.dt.page.info().serverSide)
					for (var c = 0, d = this.s.dt.rows({ search: 'applied' }).indexes().toArray(); c < d.length; c++)
						this._populatePaneArray(d[c], this.s.rowData.arrayFilter, a, this.s.rowData.binsShown);
			};
			b.prototype._getMessage = function (a) {
				var c = this.s.dt.i18n('searchPanes.count', this.c.i18n.count),
					d = this.s.dt.i18n('searchPanes.countFiltered', this.c.i18n.countFiltered);
		...
		I = (function () {
			function h(b, a, c, d) {
				...
				this.dom = {
					...
					collapseAll: D('<button type="button"/>')
						...
						.html(f.i18n('searchPanes.collapseMessage', this.c.i18n.collapseMessage)),
					container: D('<div/>')
							...
							if (g === t) {
								...
								for (t = e.s.selectionList; m < t.length; m++) {
									...
									for (var x = 0; x < A.rows.length; x++)
										(w.searchPanes[z][x] = A.rows[x]), null === w.searchPanes[z][x] && (w.searchPanes_null[z][x] = !0);
								}
			...
			h.prototype.rebuild = function (b, a) {
				...
				for (var c = [], d = 0, e = this.s.panes; d < e.length; d++) {
					...
					if (!1 === b || f.s.index === b)
						f.clearData(),
							f.rebuildPane(this.s.dt.page.info().serverSide ? this.s.serverData : void 0, a),
				...
				var b = this,
					...
					c = function (d) {
						d &&
							...
							((b.s.serverData = d), (b.s.serverData.tableLength = d.recordsTotal), b._serverTotals());
					};
			...
			h.prototype._paneDeclare = function (b, a, c) {
				...
				for (var e = b.columns().eq(0).toArray().length, f = 0; f < this.c.panes.length; f++)
					this.s.panes.push(new this.s.paneClass(a, c, e + f, this.dom.panes, this.c.panes[f]));
						...
						for (var t = a.s.panes; g < t.length; g++) {
							...
							if (w.s.dtPane) {
								...
								for (var z = 0; z < w.length; z++)
									(m.searchPanes[A][z] = w[z].filter), m.searchPanes[A][z] || (m.searchPanes_null[A][z] = !0), f++;
							}
						}
						0 < f &&
							(f !== a.s.filterCount ? ((m.start = 0), (a.s.page = 0)) : (m.start = a.s.page * a.s.dt.page.len()),
							a.s.dt.page(a.s.page),
							(a.s.filterCount = f));
						0 < a.s.selectionList.length &&
							(m.searchPanesLast = a.s.dt.column(a.s.selectionList[a.s.selectionList.length - 1].column).dataSrc());
					});
				else
			...
			function b(a, c, d) {
				...
				e.s.dt.off('init.dtsps').on('init.dtsps', function () {
					return e._initSelectionListeners(
						!0,
						g && g.searchPanes && g.searchPanes.selectionList ? g.searchPanes.selectionList : e.c.preSelect
					);
				});
				return e;
			}
					...
					if (void 0 !== a) {
						...
						0 < c.length
							? (this.s.selectionList.push({ column: a.s.index, rows: c }),
							  a.dom.clear.removeClass(this.classes.disabledButton).removeAttr('disabled'))
			...
			b.prototype._remakeSelections = function () {
				...
				if (this.s.dt.page.info().serverSide) {
					...
					0 < this.s.selectionList.length &&
						(e = this.s.panes[this.s.selectionList[this.s.selectionList.length - 1].column]);
					for (var a = 0, c = this.s.panes; a < c.length; a++)
						(x = c[a]), !x.s.displayed || (e && x.s.index === e.s.index) || x.updateRows();
				} else {
...
(function (c) {
	'function' === typeof define && define.amd
		? define(['jquery', 'datatables.net-dt', 'datatables.net-searchpanes'], function (b) {
				return c(b);
		  })
		: 'object' === typeof exports
		? (module.exports = function (b, a) {
