...
featured: false
relatedLinks:
  - label: "Browse all starship components"
    href: "/starships"
...
faqs:
  ...
  - question: "What's the difference between a system freighter and a capital freighter?"
    answer: "System freighters have 15-19 cargo slots and cost 5-23M units. Capital freighters have 24-34 cargo slots, cost up to 178M units, and are far more powerful. Capital freighters only spawn during rescue events after you've had two prior rescue events."
  - question: "Does the Pirate Dreadnought come in S-class?"
    answer: "Yes. The Pirate Dreadnought can be claimed as an S-class freighter using the same save scum process, and it has the same stat ranges as other capital freighters. It's also a unique design you can't get any other way."
  - question: "How long does save scumming for an S-class freighter take?"
...
1. Use the Economy Scanner to identify a wealthy 3-star system on the galaxy map.
2. Warp to a system adjacent to your target. Don't warp directly in yet. The rescue event cooldown needs to be active first: 3 hours of unpaused game time + 5 warps since your last rescue event. Time spent in the options menu doesn't count toward the 3-hour timer, so make sure you're actually playing.
3. Once the cooldown has reset, create a manual save by getting out of your ship at the space station, then getting back in. This is your pre-warp restore point.
4. Warp into your target wealthy system. If a rescue event triggers, you'll immediately see a freighter under attack.
5. Look at the freighter design. Like what you see? Fly straight to the space station, exit your ship to create a new restore point, then fly back out. This is your Stage 2 restore point.
6. Don't like the design? Reload your pre-warp save, warp to a different system, and repeat. Each system spawns a different design.
...
7. Fly to the freighter and land in the hangar bay.
8. Before talking to the captain, scan the hangar wall with your Analysis Visor. The class shows up in the scan. This saves you the boarding process on a C-class.
