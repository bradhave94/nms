...
faqs:
  ...
  - question: "What are the three Swarm expedition factions?"
    answer: "Royals (red, authority and command), Sages (green, knowledge and insight), and Weavers (blue, connection and creation). Your faction is assigned by a personality quiz when you start. All factions share the same core rewards, but only one gets memorialized in the Space Anomaly."
  - question: "What are Purge, Restoration, and Sabotage missions?"
    answer: "The three mission types that drive Prismatic Core construction in Phase 3. Purge has you dogfighting swarmers. Restoration sends sweeper teams to cleanse contaminated planets. Sabotage deploys you from the Anomaly to intercept the swarm network. Each type contributes differently to the build rate."
  - question: "How do you beat the Hive of Glass?"
    answer: "Fly through the rotating laser wheel and target the central core. Hits on the core are guaranteed critical hits in update 6.4. Clear escort drone swarmers first with burst or missile weapons, then focus sustained damage on the core."
  - question: "What is Corrupted Ichor and how do you get it?"
    answer: "Corrupted Ichor is a new raw material introduced in update 6.4. Get it by using the Gravitino Coil to dismantle fallen swarmer ships. It's required early in Phase 1 when you bring it to Specialist Polo, and it shows up again in the research chain."
  - question: "What are all the Swarm expedition rewards?"
...
| Faction | Color | Theme |
| --- | --- | --- |
| Royals | Red | Authority and command |
...
| --- | --- | --- |
| Purge | Dogfight swarmer ships, clear infested systems | Direct combat progress |
...
| --- | --- |
| Fragmented | Follow the marker to the crashed ship wreck |
| To Live | Craft and install the three Soul Fragment blueprints from the crash site |
| To Be Haunted | Return to your ship, offer the fragments to the pilot echo |
| Forged Signature | Craft the Pilot Signature from the recipe in the previous step |
| Contact | Repair two damaged ship components, then accept the signal |
| A Shadow Above | Fly toward the Hive of Glass, then destroy the ambushing swarmers |
| Stratagem | Summon the Anomaly, hand Polo your [Corrupted Ichor](/raw/SWARMDUST), ask about fragmentation |

Phase 1 ends when you finish the conversation with Polo. The A Shadow Above task is the first real combat encounter. Swarmers are fast and travel in packs. Keep moving and pick them off individually rather than trying to fight the whole group at once.

### Phase 2

Phase 2 pushes you into deeper space. Install a Cadmium Drive before you start since the galaxy map route involves red-star jumps.

| Milestone | How to complete |
| --- | --- |
| Crash Site | Open the galaxy map and follow the guided route to the crashed swarmer wreck |
| Disassembly | Use the [Gravitino Coil](/blog/gravitino-coil-guide-no-mans-sky) to dismantle the wreck parts |
| Divine Intelligence | Help a freighter captain by destroying two cargo loads, then present Corrupted Ichor to the Atlas at Popoli Read |
| Emperor of Glass | Engage the Hive of Glass core (you will be pulled into the World of Glass) |
...
| Reward | Type |
| --- | --- |
| [Direwasp Helm](/other/SWARM_HAT) | Armor |
| [Direwasp Chestpiece](/other/SWARM_TORSO) | Armor |
| [Direwasp Plating](/other/SWARM_ARMOUR) | Armor |
| [Direwasp Gloves](/other/SWARM_GLOVES) | Armor |
| [Direwasp Cuisses](/other/SWARM_LEGS) | Armor |
| [Direwasp Boots](/other/SWARM_BOOTS) | Armor |
| [Direwasp Disintegrator](/other/SWARM_GUN) | Rifle multi-tool |
| [Direwasp Flightpack](/other/SWARM_PACK) | Jetpack |
| Team flags (3 styles per faction) | Base decoration |
| Soul fragment poster set | Base decoration |
