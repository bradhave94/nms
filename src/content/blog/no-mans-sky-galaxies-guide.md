...
relatedLinks:
  ...
  - label: "Browse Hyperdrive upgrades"
    href: "/upgrades"
  - label: "Browse all technology"
    href: "/technology"
  - label: "Crafting calculator"
    href: "/calculator"
faqs:
  - question: "How many galaxies are in No Man's Sky?"
    answer: "256 galaxies exist in the universe, numbered 1 through 256. Only galaxies 1 through 255 can be reached through normal play. Galaxy 256 (Odyalutai) and the legacy Yilsrussimil have been unreachable through normal gameplay since the Atlas Rises update in 2017."
  - question: "How do you get to the next galaxy in No Man's Sky?"
    answer: "Two main methods. The slow one is reaching the Galaxy Centre with a fully charged Hyperdrive — usually with several black hole jumps in between. The fast one is finishing the Artemis Path and choosing a galaxy type at the New Beginnings mission, which jumps you to the next galaxy of that type in the sequence."
  - question: "Can you travel back to a previous galaxy in No Man's Sky?"
    answer: "Yes. Use a base teleporter or the Space Anomaly's teleporter. Both ignore galaxy boundaries as long as you have a base in the destination galaxy or are visiting another player. This is why you should always drop a Base Computer in every new galaxy you enter."
  - question: "Does anything carry over when you change galaxies?"
    answer: "Yes — your ship, exosuit, multi-tool, units, nanites, blueprints, and inventory all carry over. What breaks is the upgrade modules in your active ship, suit and multi-tool: those need to be repaired on arrival. Base technology (Launch Thrusters, Pulse Drive, Hyperdrive) is unaffected. Black hole jumps no longer damage anything since the Waypoint update."
  - question: "What is the best galaxy in No Man's Sky?"
    answer: "Euclid is where everyone starts and has by far the largest player community. Eissentam (galaxy 10) is the most popular destination after Euclid because it's a Lush galaxy and home to the Galactic Hub Eissentam community. Most other galaxies are interchangeable for practical purposes."
  - question: "What is a Lush galaxy in No Man's Sky?"
    answer: "Lush galaxies have a higher chance of producing Earth-like planets — green grass, mild weather, more flora and fauna. They appear with a green hologram on the New Beginnings galaxy selection screen and use names like Halcyon, Inspiring, Serene, or Tranquil. Eissentam is the best-known example."
  - question: "Do black holes still damage your ship in No Man's Sky?"
    answer: "No. Black hole travel stopped damaging technology with the Waypoint update. Modules only break during galactic centre transitions — going to the next galaxy still resets your ship, suit and multi-tool upgrades."
  - question: "What does the portal address 100104005005 do?"
...
Each galaxy contains billions of procedurally generated star systems, regions, and planets. The underlying mechanics — resources, recipes, factions, faction progression, base building, expeditions, multiplayer — are identical across all of them. Galaxy hopping doesn't unlock new content. It changes the seed.
...
| --- | --- | --- | --- | --- |
| Norm | 178 | Cyan | Imperfect / Improved / Parallel / Rebuilt | Balanced |
| Lush | 25 | Green | Halcyon / Inspiring / Serene / Tranquil | 4× lush, fewer dead worlds |
| Harsh | 26 | Red | Burning / Raging / Relentless / Ruthless | More extreme biomes |
| Empty | 26 | Blue | Ancestral / Frozen / Exhausted / Silent | 4× dead, sparse systems |
...
A black hole jump pulls you, on average, around 7,000 light-years closer to the centre per use. The trip isn't linear — you might travel further but end up at a tangent — but each jump still nets a meaningful chunk of distance. Stack five to eight of them and you're inside Galactic Centre range.
...
There's a soft cap on bases — 449. After that, new Base Computers won't appear in the teleporter list until you remove one. If you're a serial galaxy hopper, plan accordingly.
